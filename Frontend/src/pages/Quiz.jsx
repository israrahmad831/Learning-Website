  ...
  useEffect(() => {
    const fetchQuizDetails = async () => {
      try {
        ...
        const response = await fetch(`${BACKEND_URL}/api/quizzes/${id}`);
        if (!response.ok) {
        ...
        <div className="bg-gray-50 p-6 rounded-md mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div className="bg-white p-4 rounded-md text-center">
              ...
              <p className="text-2xl font-bold">
                {Math.floor(quizResult?.timeSpent || 0 / 60)}:
                {(quizResult?.timeSpent || 0) % 60 < 10 ? "0" : ""}
                {(quizResult?.timeSpent || 0) % 60}
              </p>
            </div>
          </div>
          <div className="bg-white p-4 rounded-md text-center">
            ...
            {showCertificate && (
              ...
              >
                ...
                <p className="text-gray-500 mt-1">
                  with a passing score of {quizResult.percentage}%.
                </p>
